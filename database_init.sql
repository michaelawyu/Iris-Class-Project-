...
CREATE TABLE SECTIONS_NEW (
	...
	FOREIGN KEY (product_id) REFERENCES DEVS_PRODUCTS(product_id));
...
CREATE TABLE POSTS_NEW (
	...
	FOREIGN KEY (product_id, section_id) REFERENCES SECTIONS_NEW(product_id, section_id));
...
CREATE TABLE FOLLOWUPS_NEW (
	...
	FOREIGN KEY (product_id, section_id, post_id) REFERENCES POSTS_NEW(product_id, section_id, post_id));
